...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center px-5 py-10">
      ...
      <h1 className="font-display mt-6 text-2xl text-foreground">Iniciar sesión</h1>
      <p className="mt-1 text-sm text-zinc-500">Accede a tu cuenta de Keys4Travels.</p>
      ...
      <p className="mt-5 text-sm text-zinc-500">
        ¿No tienes cuenta?{" "}
        <Link href="/registro" className="font-medium text-brand underline underline-offset-2">
          Regístrate
        </Link>
      </p>
    </div>
