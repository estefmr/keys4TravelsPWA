/**
 * Logo de WhatsApp como SVG inline. Lucide no incluye marcas comerciales,
 * así que lo dibujamos aquí y lo compartimos entre la pantalla de Contacto
 * y el botón del formulario.
 */
export default function WhatsAppGlyph({ className = "h-4 w-4" }: { className?: string }) {
  return (
